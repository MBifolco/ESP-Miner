...
void SYSTEM_init_system(GlobalState * GLOBAL_STATE)
{
    ...
    module->overheat_mode = nvs_config_get_u16(NVS_CONFIG_OVERHEAT_MODE, "");
...
{
    SystemModule * module = &GLOBAL_STATE->SYSTEM_MODULE;
    uint16_t new_overheat_mode = nvs_config_get_u16(NVS_CONFIG_OVERHEAT_MODE,"");
...
static esp_err_t ensure_overheat_mode_config() {
    ...
    if (overheat_mode == UINT16_MAX) {
        ...
        nvs_config_set_u16(NVS_CONFIG_OVERHEAT_MODE,"");
